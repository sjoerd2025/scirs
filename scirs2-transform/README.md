...
```toml
[dependencies]
scirs2-transform = { version = "0.1.0-beta.3", features = ["parallel"] }
```
...
**Ready for Production**: SciRS2 Transform v0.1.0-beta.3 provides production-ready data transformation capabilities with performance that meets or exceeds established Python libraries while offering Rust's safety and performance guarantees.