...
fn test_one_vs_one_accuracy() {
    ...
    let acc_1 = one_vs_one_accuracy(&y_true_1, &y_pred_1).expect("Operation failed");
    ...
    let acc_2 = one_vs_one_accuracy(&y_true_2, &y_pred_2).expect("Operation failed");
    ...
    let acc_3 = one_vs_one_accuracy(&y_true_3, &y_pred_3).expect("Operation failed");
...
fn test_one_vs_one_precision_recall() {
    ...
    let y_true_1 = array![0, 1, 2, 0, 1, 2];
    let y_pred_1 = array![0, 1, 2, 0, 1, 2];
    let (precision_1, recall_1) =
        one_vs_one_precision_recall(&y_true_1, &y_pred_1).expect("Operation failed");
    ...
    let y_true_2 = array![0, 1, 2, 0, 1, 2];
    let y_pred_2 = array![0, 2, 1, 0, 0, 2];
    let (precision_2, recall_2) =
        one_vs_one_precision_recall(&y_true_2, &y_pred_2).expect("Operation failed");
...
fn test_one_vs_one_f1_score() {
    ...
    let y_true_1 = array![0, 1, 2, 0, 1, 2];
    let y_pred_1 = array![0, 1, 2, 0, 1, 2];
    let f1_scores_1 = one_vs_one_f1_score(&y_true_1, &y_pred_1).expect("Operation failed");
    ...
    let y_true_2 = array![0, 1, 2, 0, 1, 2];
    let y_pred_2 = array![0, 2, 1, 0, 0, 2];
    let f1_scores_2 = one_vs_one_f1_score(&y_true_2, &y_pred_2).expect("Operation failed");
...
fn test_weighted_one_vs_one_f1_score() {
    ...
    let y_pred_1 = array![0, 1, 2, 0, 1, 2];
    let weighted_f1_1 =
        weighted_one_vs_one_f1_score(&y_true_1, &y_pred_1).expect("Operation failed");
    ...
    let y_pred_2 = array![0, 2, 1, 0, 0, 2];
    let weighted_f1_2 =
        weighted_one_vs_one_f1_score(&y_true_2, &y_pred_2).expect("Operation failed");
    ...
    let weighted_f1_3 =
        weighted_one_vs_one_f1_score(&y_true_3, &y_pred_3).expect("Operation failed");
