...
**Version 0.1.0-rc.4** (SciRS2 POLICY & Enhanced Performance) - Production-grade stability with ecosystem consistency:
...
```toml
[dependencies]
scirs2-ndimage = { version = "0.1.0-rc.4", features = ["parallel", "simd"] }
