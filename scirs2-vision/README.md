...
```toml
[dependencies]
scirs2-vision = { version = "0.1.0-rc.3", features = ["parallel"] }
```
...
This **0.1.0-rc.3** release represents a mature, production-ready computer vision library suitable for:
