...
**Production-Ready Automatic Differentiation for Rust (v0.1.0-rc.3)**
...
```toml
[dependencies]
scirs2-autograd = { version = "0.1.0-rc.3", features = ["blas", "simd"] }
```
...
SciRS2 Autograd v0.1.0-rc.3 is **Release Candidate 2** and is **production-ready**:
