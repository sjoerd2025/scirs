...
```toml
[dependencies]
scirs2-neural = { version = "0.1.0-rc.2", features = ["simd", "parallel"] }

# For performance optimization
scirs2-neural = { version = "0.1.0-rc.2", features = ["jit", "cuda"] }

# For integration with scirs2-metrics
scirs2-neural = { version = "0.1.0-rc.2", features = ["metrics_integration"] }
```
