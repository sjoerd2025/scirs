...
**v0.1.0-rc.4** - SciRS2 POLICY & Enhanced Performance
...
```toml
[dependencies]
scirs2-linalg = { version = "0.1.0-rc.4", features = ["openblas"] }
# Or use Intel MKL:
# scirs2-linalg = { version = "0.1.0-rc.4", features = ["mkl"] }
```
...
scirs2-linalg = { version = "0.1.0-rc.4", features = ["netlib"] }
```
