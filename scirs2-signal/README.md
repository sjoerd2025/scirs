...
```toml
[dependencies]
scirs2-signal = "0.1.0-rc.3"
scirs2-core = "0.1.0-rc.3"
ndarray = "0.16.1"
```

> **Note**: This is **Release Candidate 2** (rc.2). The API is stable and production-ready with minimal changes expected before 1.0.
