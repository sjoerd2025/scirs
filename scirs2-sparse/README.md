...
**Production-ready sparse matrix library for Rust** - rc.2 release (0.1.0-rc.3) with SciRS2 POLICY implementation.
...
```toml
[dependencies]
scirs2-sparse = { version = "0.1.0-rc.3", features = ["parallel", "simd"] }
```
