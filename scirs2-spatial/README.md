...
```toml
[dependencies]
scirs2-spatial = { version = "0.1.0-rc.4", features = ["parallel"] }
```
...
**scirs2-spatial v0.1.0-rc.4** is production-ready with:
...
**This is Release Candidate 4** (rc.4) - the module is production-ready with proven performance, reliability, and zero-warning code quality.
