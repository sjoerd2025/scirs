...
**Production-ready sparse matrix library for Rust** - Beta 4 release (0.1.0-beta.4) with SciRS2 POLICY implementation.
...
```toml
[dependencies]
scirs2-sparse = { version = "0.1.0-beta.4", features = ["parallel", "simd"] }
```
