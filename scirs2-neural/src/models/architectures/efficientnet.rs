...
impl EfficientNetConfig {
    ...
    pub fn efficientnet_b0(_input_channels: usize, numclasses: usize) -> Self {
        let stages = vec![
    ...
    pub fn efficientnet_b1(_input_channels: usize, numclasses: usize) -> Self {
