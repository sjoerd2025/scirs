...
This is a critical hotfix release that resolves all compilation errors present in v0.1.0-beta.2 when downloaded from crates.io. **v0.1.0-beta.2 has been yanked from crates.io** due to these compilation failures.
...
All features and capabilities from v0.1.0-beta.2 remain fully intact:
...
### Upgrade Urgency
- **Immediate upgrade recommended** for all users of v0.1.0-beta.2
- **v0.1.0-beta.2 is yanked** and will no longer be available for new installations
...
**Note**: This hotfix release demonstrates our commitment to providing a stable, reliable foundation for the scientific computing community. We apologize for the inconvenience caused by v0.1.0-beta.2 and appreciate your patience as we resolved these critical issues.