...
scirs2-optimize = { version = "0.1.0-rc.4", features = ["parallel", "simd"] }
```
...
1. **Enable Parallelization**:
   ```toml
   scirs2_optimize = { version = "0.1.0-rc.4", features = ["parallel"] }
   ```

2. **Use SIMD Operations**:
   ```toml
   scirs2_optimize = { version = "0.1.0-rc.4", features = ["simd"] }
   ```
