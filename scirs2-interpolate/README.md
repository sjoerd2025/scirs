...
## 🚀 Version 0.1.0-rc.2 - Production rc.2 Release
...
```toml
[dependencies]
scirs2-interpolate = "0.1.0-rc.2"

# Optional: Enable high-performance features
scirs2-interpolate = { version = "0.1.0-rc.2", features = ["simd", "linalg"] }
```
...
## 📊 Production Status - Ready for 0.1.0-rc.2
...
### **🎯 Release Readiness**
This crate is **production-ready** for the 0.1.0-rc.2 release with stable APIs, comprehensive testing, and performance that meets or exceeds SciPy in most use cases.
